...
/**
 * Worktree Remove Script (Bare Repository Version)
 *
 ...
 *
 * Usage: pnpm worktree:remove <ticket-id>
 * Example: pnpm worktree:remove ENG-123
 */
...
async function main() {
  ...
  if (!ticketId) {
    ...
    console.log('\nUsage: pnpm worktree:remove <ticket-id>');
    console.log('Example: pnpm worktree:remove ENG-123');
    process.exit(1);
  }
